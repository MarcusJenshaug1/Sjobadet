import{j as e}from"./jsx-runtime-DDl-KI2x.js";import{b as a}from"./iframe-C_JdCeVj.js";import{M as u}from"./map-pin-O-PiCWul.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-DMVqFKYz.js";function i({address:d,mapEmbedUrl:r,saunaName:l}){const[m,o]=a.useState(!1),t=a.useRef(null);return a.useEffect(()=>{if(!r)return;const s=new IntersectionObserver(p=>{p[0].isIntersecting&&(o(!0),s.disconnect())},{rootMargin:"200px"});return t.current&&s.observe(t.current),()=>s.disconnect()},[r]),r?e.jsxs("div",{ref:t,style:{minHeight:"300px",display:"flex",flexDirection:"column"},children:[e.jsx("p",{style:{marginBottom:"1rem",color:"#475569"},children:d}),e.jsx("div",{style:{position:"relative",flex:1,backgroundColor:"#f1f5f9",borderRadius:"0.75rem",overflow:"hidden",minHeight:"300px"},children:m?e.jsx("iframe",{src:r,title:`Kart over ${l}`,width:"100%",height:"100%",style:{border:0,position:"absolute",top:0,left:0},allowFullScreen:!0,loading:"lazy",referrerPolicy:"no-referrer-when-downgrade"}):e.jsxs("div",{style:{height:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"1rem",padding:"2rem",textAlign:"center"},children:[e.jsx(u,{size:48,color:"#94a3b8"}),e.jsx("button",{onClick:()=>o(!0),style:{padding:"0.75rem 1.5rem",backgroundColor:"var(--primary)",color:"white",border:"none",borderRadius:"0.5rem",fontWeight:"600",cursor:"pointer"},children:"Last inn kart"})]})})]}):null}i.__docgenInfo={description:"",methods:[],displayName:"SaunaMap",props:{address:{required:!0,tsType:{name:"string"},description:""},mapEmbedUrl:{required:!0,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:""},saunaName:{required:!0,tsType:{name:"string"},description:""}}};const c=`# SaunaMap\r
\r
