import{j as e}from"./jsx-runtime-DDl-KI2x.js";import{R as p}from"./iframe-C_JdCeVj.js";import{c as m}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";const g="_select_1qow0_1",u="_sm_1qow0_59",k="_md_1qow0_69",v="_lg_1qow0_77",l={select:g,sm:u,md:k,lg:v},r=p.forwardRef(({size:s="md",className:i,children:a,...d},c)=>e.jsx("select",{ref:c,className:m(l.select,l[s],i),...d,children:a}));r.displayName="Select";r.__docgenInfo={description:"",methods:[],displayName:"Select",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}}},composes:["Omit"]};const S=`# Select\r
\r
...
}`,...o.parameters?.docs?.source}}};const y=["Standard","Størrelser","Tilstander"];export{t as Standard,n as Størrelser,o as Tilstander,y as __namedExportsOrder,f as default};
